    <div id="map-container" style="position: relative;height: 880px;width: 1500px;padding:20px">
        <div id="location-container" style="position: absolute;top: 30px;left: 30px;z-index: 1000;background-color: white;padding: 20px;border-radius: 5px;">
        ...
        <div class="card" style="height: 880px;width: 1500px;">
