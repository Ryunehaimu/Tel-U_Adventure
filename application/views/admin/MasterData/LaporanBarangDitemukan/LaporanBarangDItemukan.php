<nav class="navbar bg-body-tertiary" style="background-color:white;">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="tanggalLaporan" class="form-label">Tanggal Ditemukan</label>
    ...
    <script>
        ...
        document.getElementById('saveLaporanBarangHilang').addEventListener('click', function() {
            ...
            var tanggal = document.getElementById('tanggalLaporan').value;
        ...
        function editUser(index) {
            ...
            document.getElementById('tanggalLaporan').value = user.tanggal;
        ...
        function saveEdit(index) {
            ...
            let newTanggal = document.getElementById("tanggalLaporan").value;
