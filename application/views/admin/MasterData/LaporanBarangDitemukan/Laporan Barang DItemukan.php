    ...
    <div class="row">
      <div class="col-md-4">
        <form>
          <div class="input-group mb-3">
            <input type="text" class="form-control" id="inputData" placeholder="Cari Barang Ditemukan">
            <div class="input-group-append">
              <button type="button" class="btn btn-primary">
                <img src="../../../../assets/img//cari putih.png">
                Cari
              </button>
            </div>
          </div>
      ...
      <div class="col-md-8 d-flex justify-content-end">
        <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#barangHilang">
          <img src="../../../../assets/img//tambah member putih.png">Tambah</button>
      </div>
      <!-- Modal -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                <label for="formFile" class="form-label">Tanggal Ditemukan</label>
                <input class="form-control">
              </div>
              <div class="mb-3">
      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td>Sudah diambil</td>
            <td>
              <button type="button" class="btn btn-primary"><img src="./../../../../assets/img//edit putih.png"></button>
              <button type="button" class="btn btn-danger"><img src="./../../../../assets/img//hapus putih.png"></button>
            </td>
          </tr>
        </tbody>
      </table>
