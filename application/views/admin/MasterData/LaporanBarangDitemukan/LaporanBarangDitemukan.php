        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= base_url("con_temu/update") ?>">
                    ...
                    <div class="form-group">
                        <label for="edittanggal">Tanggal Ditemukan</label>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Delete button -->
                        <a href="<?= base_url("con_temu/delete/".$row->id)?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin menghapus data ini?')">
